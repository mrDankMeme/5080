    ...
    static func makeDefaultCards() -> [RootHomePromptCard] {
        [
            ...
            RootHomePromptCard(
                id: "arctic_peace",
                title: "Arctic Peace",
                prompt: "Close-up of a winking pink Teletubby with heart sunglasses giving a peace sign in front of snowy mountains and a serene glacial lake. Highly detailed, photorealistic, 8k.",
                preview: .asset("home_trending_arctic_peace"),
                mode: .textToVideo
            ),
            RootHomePromptCard(
                id: "sky_drifter",
            ...
            RootHomePromptCard(
                id: "galactic_wave_stitch",
                title: "Galactic Wave Stitch",
                prompt: "Detailed 3D render of the character Stitch surfing on a light wood surfboard in a clear blue tropical lagoon with palm tree islands and white clouds. High fidelity, cartoon style, reflections.",
                preview: .asset("home_trending_galactic_wave_stitch"),
                mode: .frameToVideo
            ),
            RootHomePromptCard(
