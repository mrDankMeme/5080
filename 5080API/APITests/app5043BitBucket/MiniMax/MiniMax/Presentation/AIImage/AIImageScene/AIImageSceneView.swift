...
struct AIImageSceneView: View {
    ...
    private let composerMaxHeight: CGFloat = 300.scale
    private let composerTextMinHeight: CGFloat = 44.scale
    private let composerTextMaxHeight: CGFloat = 190.scale
    private let composerInputTopInset: CGFloat = 16.scale
    private let composerHorizontalInset: CGFloat = 16.scale
    private let composerControlsTopInset: CGFloat = 24.scale
    private let composerControlsBottomInset: CGFloat = 16.scale
    private let composerControlsHeight: CGFloat = 44.scale
        ...
        GeometryReader { _ in
            ...
            .overlay {
                if viewModel.isSettingsPresented {
                    AIImageSettingsSheetView(viewModel: viewModel) {
    ...
    private var composerPanel: some View {
        VStack(spacing: 0.scale) {
            ...
            .padding(.top, composerInputTopInset)
            ...
            HStack(spacing: 8.scale) {
                ...
                Button(action: onGenerate) {
                    ...
                    .frame(height: composerControlsHeight)
                    .background(
            ...
            .padding(.horizontal, composerHorizontalInset)
            .padding(.top, composerControlsTopInset)
            .padding(.bottom, composerControlsBottomInset)
        }
    ...
    private var composerHeight: CGFloat {
        let dynamicHeight = composerCurrentTextHeight +
            composerInputTopInset +
            composerControlsTopInset +
            composerControlsHeight +
            composerControlsBottomInset
