...
struct TextToVideoInspirationCard: Identifiable, Hashable {
    let id: String
    let title: String
    let prompt: String
...
enum TextToVideoInspirationCatalog {
    static let cards: [TextToVideoInspirationCard] = [
        TextToVideoInspirationCard(
